...
export default () => (
    <Container flex='1 0 auto' flexDirection="column" py={4}>
        ...
        <H2>Where do I get a Skycoin wallet?</H2>
        ...
        <H2>Do I have to sell SKY at a fixed price?</H2>
        ...
        <H2>Who provides the exchange rate?</H2>
        <P>CoinMarketCap.com</P>

        <H2>Do you provide any type of dispute resolution?</H2>
        <P>No. Everything is peer to peer.</P>

        <H2>Where can I find more information about Skycoin?</H2>
